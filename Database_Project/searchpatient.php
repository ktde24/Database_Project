...
<div class="imbody">
 ...
 <h1 style="color:green;">[환자 정보 조회 결과]</h1>
    ...
    $patient_query = "SELECT Pat_ID, Doc_ID, Nurse_ID, Pat_Name, Pat_Jumin, Pat_Gen, Pat_Add, Pat_Email, Pat_Phone, Pat_Job FROM Patient WHERE Pat_Name = '$patient_name'";
    ...
    if ($patient_count === 1) {
        ...
        // Multiple patients found, display interface for entering birthday
        ?>
        <div class="samename">
        <h5 style="color:darkgray;">동명이인이 존재합니다. 생년월일을 입력해주세요. (ex: 010219)</h5>
        <form action="search_by_birthday.php" method="post">
